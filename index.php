    ...
    <div class="row align-items-start">
        ...
        <div style="overflow-x:auto;">
            ...
            <tr>
                ...
                <?php
                $sql = "SELECT * FROM `transaction` ORDER BY sl DESC LIMIT 1";
                $query = mysqli_query($connection, $sql);
                $row = mysqli_fetch_array($query);
                $s_moba = $row["mobile"];
                $sql2="SELECT name FROM customer WHERE `mobile`= '$s_moba';";
                $query2 = mysqli_query($connection, $sql2);
                $row2 = mysqli_fetch_array($query2);
                $sql3="SELECT amount FROM paid WHERE `mobile`= '$s_moba';";
        ...
        <div class="col">
        <div class="summary">
        <h1 style="text-align: center;">Summery</h1>
            <?php
            ...
            echo "<h4>Remaining Cash :  " . $remin."</h4>";
            echo "</div>";
